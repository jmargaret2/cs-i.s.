...
\lstset{
	...
	morekeywords={var, play, SynthDef, SinOsc, Sine, Saw, add, arg, EZSlider, EZKnob, controlSpec, initVal, action, label, labelHeight, labelWidth, Button, states_, Synth, MIDIClient, MIDIIn, action_},
	frame=single,
