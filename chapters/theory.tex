...
As previously mentioned, modular synthesis involves sending an audio signal through several patches in a linear form. These patches then make changes to the audio signal, modifying the input into a different-sounding output. To do this, we start with a digital audio wave, or a sine wave function.