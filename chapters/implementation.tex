...
%TODO: fix this it doesn't make sense it says Listing 4.2.4
...
Legato, as previously defined, is a directive which indicates that a certain passage of a composition must be played smoothly, in a connected manner. Notes are no longer clearly distinctive from one another, as each note will flow gracefully into the next. 
...
The final module for the MIDI synthesizer will be a method of manually adjusting the values for the four pieces of the ADSR envelope. 
