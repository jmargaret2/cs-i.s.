...
\begin{listing}
	\begin{lstlisting}
		...
		dLevel = 0;
	\end{lstlisting}
	\caption{Altering the Attack and Decay to create a staccato module}
	\label{lst:midi-attack-decay}
\end{listing}
...
\begin{listing}
	\begin{lstlisting}
		...
		rTime = 5;
	\end{lstlisting}
	\caption{Creating the legato button for MIDI}
	\label{lst:midi-legato}
\end{listing}
